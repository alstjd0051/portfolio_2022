...
import { Facebook, Github } from "../components/AllSvags";
  ...
  return (
    <Icons>
      <motion.div initial={{ transform: "scale(0)" }} animate={{ scale: [0, 1, 1, 5, 1] }} transition={{ type: "spring", duration: 1, delay: 1 }}>
        <NavLink style={{ color: "inherit" }} target="_blank" to={{ pathname: "https://github.com/alstjd0051" }}>
      ...
      <motion.div initial={{ transform: "scale(0)" }} animate={{ scale: [0, 1, 1, 5, 1] }} transition={{ type: "spring", duration: 1, delay: 1.2 }}>
        <NavLink style={{ color: "inherit" }} target="_blank" to={{ pathname: "https://www.facebook.com/minseong.song.9/" }}>
